...
public class KnapsackProblem 
{
    ...
    public void buildKnapsackProblem() {
        ...
        System.out.println("\nMejor solución de la generación inicial: " + this.best_solution_of_generation.get(0));
	...
	System.out.println("Media del fitness de la generación inicial: " + this.mean_fitness_of_generation.get(0));
        ...
        System.out.println("Puntaje del fitness de la mejor solución de la generación inicial: " + this.best_fitness_of_generation.get(0));
    ...
    private void makeFurtherGenerations() {
		...
		if(a == b && b == c) {
            ...
            // Output best solution of generation
            System.out.println("\nMejor solución de la generación " + (i + 1) + ": " + this.best_solution_of_generation.get(i));

            // Find mean solution of generation
	    this.mean_fitness_of_generation.add(this.getMeanFitness());

	    // Output mean solution of generation
	    System.out.println("Media del fitness de la generación: " + this.mean_fitness_of_generation.get(i));

            // Compute fitness of best solution of generation
            this.best_fitness_of_generation.add(this.evalGene(this.population.get(this.getBestSolution())));

            // Output best fitness of generation
            System.out.println("Puntaje del fitness de la mejor solución de la generación " + (i + 1) + ": " + this.best_fitness_of_generation.get(i));

            // Output crossover/cloning summary
            System.out.println("Ocurrió cruce " + this.crossover_count + " veces");
            System.out.println("Ocurrió clonación " + this.clone_count + " veces");
            if(this.mutation == false) {
                System.out.println("No hubo mutación");
            }
            if(this.mutation == true) {
                System.out.println("Sí hubo mutación");
            }
        }
    }
    ...
    private void showOptimalList() {
        ...
        System.out.println("\nLista optima de los objetos a incluir en la mochila: ");
    ...
    private void getInput() 
    {
        ...
        for(int i = 0; i < number_of_items; i++) 
        {
        	...
        	val = leerDouble();
        	value_of_items.add(val);
        	
            val = 0;
            
            System.out.print("Ingrese el peso del objeto " + (i + 1) + ": ");
            val = leerDouble();
            weight_of_items.add(val);     
        }
        
        System.out.print("Ingrese la capacidad de la mochila: ");
        knapsack_capacity = leerEntero();
        
        System.out.print("Ingrese el tamaño de la población: ");
        population_size = leerEntero();
        
        System.out.print("Ingrese el número máximo de generaciones: ");
        maximum_generations = leerEntero();
        
        System.out.print("Ingrese la probabilidad de cruce: ");
        prob_crossover = leerDouble();
        
        System.out.print("Ingrese la probabilidad de mutación: ");
        prob_mutation = leerDouble();
